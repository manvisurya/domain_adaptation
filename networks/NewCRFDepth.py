...
class NewCRFDepth(nn.Module):
    ...
    def __init__(self, version=None, inv_depth=False,
        ...
        # self.upconv3 = upconv(crf_dims[3], crf_dims[3]//4)
        # self.upconv2 = upconv(crf_dims[2], crf_dims[2]//4)
        # self.upconv1 = upconv(crf_dims[1], crf_dims[1]//4)
    ...
    def forward(self, feats):
        ...
        e3 = F.dropout(e3, p=0.3, training=self.training)
        # e3 = self.upconv3(e3)
...
class trans_backbone(nn.Module):
    def __init__(self, version=None,
        ...
        if version[:-2] == 'base':
            ...
            depths = [2, 2, 18, 2]
            num_heads = [6, 12, 24, 48]
            self.num_ch_enc = [192, 384, 768, 1536]
        elif version[:-2] == 'tiny':
            embed_dim = 96
            depths = [2, 2, 6, 2]
            num_heads = [3, 6, 12, 24]
