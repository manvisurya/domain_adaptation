...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--monodepth",
                                 ...
                                 action="store_true")
        self.parser.add_argument("--sup",
                                 help="if supervised training",
                                 action="store_true")
        self.parser.add_argument("--selfsup",
                                 help="if self-supervised training",
                                 action="store_true")
        ...
        #                          default="kitti_depth",
        #                          choices=["kitti", "kitti_odom", "kitti_depth", "kitti_test", "dgp", "waymo"])
        self.parser.add_argument("--dataset",
                                 type=str,
                                 help="dataset to train on",
                                 default="kitti_depth",
                                 choices=["kitti", "kitti_odom", "kitti_depth", "kitti_test", "dgp", "waymo", "Virtual_gallery", "nyu"])
        ...
        self.parser.add_argument("--resume",
                                 ...
                                 action="store_true")
        self.parser.add_argument("--reg_path",
                                 type=str,
